/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.types --strict-vars=false` (hash: d56b5611b00c8529134d4fe441ff93de)
...
interface __BaseEnv_Env {
	...
	GROUP: DurableObjectNamespace<import("./src/index").Group>;
	FX: DurableObjectNamespace<import("./src/index").Fx>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Group" | "Fx";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "FCM_PROJECT_ID" | "FCM_SERVICE_ACCOUNT" | "EXCHANGERATE_API_KEY">> {}
}
declare module "*.sql" {
	const value: string;
