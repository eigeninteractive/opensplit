...
class DevicesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [DeviceForgotten] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeviceForgotten>> forgetDevice({
    ...
    final _path = r'/api/devices/{token}'.replaceAll(
      '{'
      r'token'
      '}',
      token.toString(),
    ...
    DeviceForgotten? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<DeviceForgotten, DeviceForgotten>(
              rawData,
              'DeviceForgotten',
              growable: true,
            );
    ...
    return Response<DeviceForgotten>(
      data: _responseData,
  ...
  Future<Response<Device>> registerDevice({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<Device, Device>(rawData, 'Device', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
