...
class InvitesApi {
  ...
  /// Whoever holds it may join until it expires or is revoked. Minting revokes the previous one; both are in the activity feed.
  ///
  /// Parameters:
  /// * [groupId]
  ...
  /// Reissuing invalidates whatever was sent before.
  ///
  /// Parameters:
  /// * [groupId]
  /// * [memberId]
  ...
  /// Walk in on a link
  /// Claiming a place sets one column on a member row that already has balances; arriving as somebody new inserts one. Never a second place for one account.
  ///
  /// Parameters:
  /// * [token]
  /// * [joinRequest]
  ...
  /// Other people&#39;s names, so a session is required, unlike the preview.
  ///
  /// Parameters:
  /// * [token]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Works with no session. A spent, expired or revoked token still describes itself.
  ///
  /// Parameters:
  /// * [token]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
