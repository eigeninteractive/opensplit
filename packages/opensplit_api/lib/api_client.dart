  ...
  static dynamic fromJson(
    ...
    try {
      switch (targetType) {
        ...
        case 'Bootstrap':
          return Bootstrap.fromJson(value);
        case 'ChangePage':
          return ChangePage.fromJson(value);
        case 'EmailFlow':
          return EmailFlowTypeTransformer().decode(value);
        ...
        case 'EntryInput':
          return EntryInput.fromJson(value);
        case 'EntryKind':
          return EntryKindTypeTransformer().decode(value);
        case 'Error':
        ...
        case 'EventKind':
          return EventKindTypeTransformer().decode(value);
        case 'GoogleIdentityRequest':
          return GoogleIdentityRequest.fromJson(value);
        case 'Group':
          return Group.fromJson(value);
        case 'GroupCreate':
          return GroupCreate.fromJson(value);
        case 'GroupPatch':
          return GroupPatch.fromJson(value);
        case 'Health':
          return Health.fromJson(value);
        case 'IdentityOutcome':
          return IdentityOutcome.fromJson(value);
        case 'IdentityOutcomeOneOf':
          return IdentityOutcomeOneOf.fromJson(value);
        case 'IdentityOutcomeOneOf1':
          return IdentityOutcomeOneOf1.fromJson(value);
        case 'Member':
          return Member.fromJson(value);
        case 'MemberCreate':
          return MemberCreate.fromJson(value);
        case 'MemberPatch':
          return MemberPatch.fromJson(value);
        case 'Payer':
          return Payer.fromJson(value);
        case 'Retry':
          return RetryTypeTransformer().decode(value);
        case 'Share':
          return Share.fromJson(value);
        case 'SplitKind':
          return SplitKindTypeTransformer().decode(value);
        default:
          dynamic match;
          if (value is List &&
