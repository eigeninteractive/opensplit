...
String parameterToString(dynamic value) {
  ...
  if (value is EmailFlow) {
    return EmailFlowTypeTransformer().encode(value).toString();
  }
  if (value is EntryKind) {
    return EntryKindTypeTransformer().encode(value).toString();
  }
  if (value is EventKind) {
    return EventKindTypeTransformer().encode(value).toString();
  }
  if (value is Retry) {
    return RetryTypeTransformer().encode(value).toString();
  }
  if (value is SplitKind) {
    return SplitKindTypeTransformer().encode(value).toString();
  }
